...
CREATE TABLE sys_operation_log (
    ...
    params         TEXT         DEFAULT NULL COMMENT '请求参数短摘要',
    request_info   MEDIUMTEXT   DEFAULT NULL COMMENT '请求信息(JSON，已脱敏/截断)',
    response_info  MEDIUMTEXT   DEFAULT NULL COMMENT '响应信息(JSON，已脱敏/截断)',
